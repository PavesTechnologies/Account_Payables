...
if TYPE_CHECKING:
    from Backend.Data_Access_Layer.models.master import StatusMaster, Currency
...
class PurchaseOrderLine(Base):
    ...
    goods_receipt_line: Mapped[list['GoodsReceiptLine']] = relationship('GoodsReceiptLine', back_populates='po_line')
    invoice_line: Mapped[list['InvoiceLine']] = relationship('InvoiceLine', back_populates='po_line')
...
class GoodsReceipt(Base):
    ...
    goods_receipt_line: Mapped[list['GoodsReceiptLine']] = relationship('GoodsReceiptLine', back_populates='grn')
